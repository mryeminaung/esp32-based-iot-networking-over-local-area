...
export default function ActivityLog() {
	...
	return (
		<Card className="w-full">
			<CardHeader className="p-4 sm:p-5 md:p-6 pb-3 sm:pb-4 md:pb-5">
				<h2 className="flex items-center gap-2 text-[0.9375rem] sm:text-[1rem] md:text-[1.1rem] font-bold">
					<History
						size={16}
					...
					<Button
						...
						size="sm"
						onClick={clearLogs}
						className="ml-auto text-[0.6875rem] sm:text-[0.7rem] md:text-[0.75rem] font-semibold text-text-muted hover:text-danger hover:bg-danger/5 whitespace-nowrap h-auto px-2 sm:px-2.5 md:px-3 py-1">
						Clear
					</Button>
				</h2>
			</CardHeader>
