...
const SENSOR_CONFIG = [
 { key: "temperature" as const, icon: Thermometer, label: "Temperature", unit: "°C", iconClass: "bg-orange-100 dark:bg-orange-900/20 text-orange-600 ", invert: false },
 { key: "humidity" as const, icon: Droplets, label: "Humidity", unit: "%", iconClass: "bg-blue-100 dark:bg-blue-900/20 text-blue-600 ", invert: false },
 { key: "soilMoisture" as const, icon: Sprout, label: "Soil Moisture", unit: "%", iconClass: "bg-green-100 text-green-600 ", invert: false },
